...
FINAL_RETRY_SCENES = {
    ...
    "ket_better_adj_adv": "exactly two copies of the same blue toy car: the left copy has a wheel fully detached beside it, while the right copy has all four wheels attached and a child gives it thumbs up",
    ...
    "ket_half_price_adj": "exactly two identical red toy boats: the left boat beside eight smooth blank coins and the right boat beside exactly four smooth blank coins",
    ...
    "ket_never_adv": "exactly four equal panels of the same child pushing away the same bowl of broccoli in every panel, with broccoli in every panel and no other food",
    ...
    "ket_off_adv": "one dark unlit lamp filling the left half of the image and one close hand pressing a plain wall switch downward on the right half, no glow anywhere",
    ...
    "ket_problem_n": "a complete bicycle standing still with its front wheel completely detached and lying far beside the empty front fork while a worried child examines both",
    ...
    "ket_total_adj_n": "two side bowls tilted inward with both bowls being poured at the same time into one center basket that collects all five apples together",
