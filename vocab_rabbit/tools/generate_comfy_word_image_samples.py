...
FINAL_RETRY_SCENES = {
    ...
    "ket_behind_adv_prep": "one solid blue box in the foreground hiding almost all of a red ball, with only a narrow curved edge of the ball visible from directly behind the box",
    "ket_better_adj_adv": "exactly two side-by-side versions of the same toy car: the left car has a detached wheel, while the right car is fully repaired and rolling smoothly",
    ...
    "ket_euro_n": "a neat pile of completely blank gold-and-silver European-style coins, every coin smooth with no symbols, letters, or numbers",
    "ket_exactly_adv": "one uniquely shaped green puzzle piece fitted perfectly and completely inside its one matching empty hole in a nearly finished puzzle",
    ...
    "ket_half_price_adj": "exactly two identical toy boats: the left boat beside eight blank coins and the right boat beside exactly four blank coins, no tags",
    ...
    "ket_left_hand_adj": "one child facing the viewer, drawing with the child's left hand on the viewer's right side, a red bracelet on that left wrist, while the other hand stays behind the back",
    "ket_look_out_phr_v": "exactly two children: one urgently points toward a fast bicycle approaching while warning the other child, who has not noticed it",
    ...
    "ket_mistake_n": "a nearly complete shape puzzle where a child notices one triangular piece placed over a clearly square hole and reaches to correct it",
    ...
    "ket_never_adv": "exactly four side-by-side scenes of the same child being offered broccoli and pushing it away every single time without ever eating it",
    ...
    "ket_off_adv": "a close hand pressing a plain wall switch downward while the nearby lamp is completely dark with no glow or light rays",
    ...
    "ket_problem_n": "a bicycle with its front wheel fully detached on the ground while a worried child kneels and examines how to solve the problem",
    ...
    "ket_ruler_n": "one plain wooden ruler measuring a toy car, showing evenly spaced tick marks only and absolutely no digits or letters",
    "ket_sale_n": "many shoppers choosing clothes from one crowded special rack while each shopper gives a shopkeeper a small pile of blank coins, no signs",
    ...
    "ket_sometimes_adv": "exactly six equal panels of the same child: exactly two panels show cycling and the other four show four different activities",
    ...
    "ket_total_adj_n": "two apples from a left bowl and three apples from a right bowl being combined into one center basket containing exactly five apples, no digits",
