...
ACTION_SCENES = {
    ...
    "ket_become_v": "one horizontal life-cycle scene with a caterpillar on the left, a chrysalis in the center, and a butterfly on the right, all three fully visible",
    ...
    "ket_belong_v": "a nearly complete puzzle board with one empty puzzle-shaped hole and one matching loose piece hovering directly beside that hole",
    ...
    "ket_bring_back_v": "exactly two children facing each other as the first child returns a red ball directly into the second child's waiting hands",
    "ket_brush_n_v": "a school-age child actively brushing their teeth with a toothbrush at a bathroom sink, with clean foam around the teeth and no writing",
    ...
    "ket_come_v": "a waiting adult with open arms on the right while a child clearly walks toward the adult from the left",
    ...
    "ket_copy_v": "a left reference card with one completed red flower and a right blank card where a child copies the exact same red flower",
    ...
    "ket_excuse_v": "a crowded doorway where a polite child gently touches an adult's elbow and the adult steps aside to let the child pass",
    ...
    "ket_fix_v": "a bicycle upside down with a detached chain clearly visible while a kneeling child repairs the chain using a wrench",
    ...
    "ket_get_fit_v": "one child completing three exercise stations side by side: running, stretching, and jumping rope, no signs",
    ...
    "ket_help_v_n": "exactly two children beside one fallen bicycle: one child looks distressed while the other child actively helps lift the bicycle",
    ...
    "ket_invent_v": "a child at a workbench actively inventing a small machine with loose gears and wheels spread beside the unfinished device",
    "ket_invite_v": "exactly two children at an open doorway: the host gestures warmly inward while the invited guest approaches from outside, plain balloons nearby",
    ...
    "ket_lose_v": "a worried child searching empty pockets in front of a bench while the missing red ball is hidden completely behind a bench and unseen by the child",
    "ket_make_v": "a child making a small clay bowl by hand at a craft table",
    "ket_make_sure_that_v": "a stationary child standing beside a parked bicycle, using both hands to check and fasten the helmet strap under the chin",
    ...
    "ket_sell_v": "a clear market exchange: customer places one plain coin into the seller's hand while the seller gives the customer one apple",
    ...
    "ket_share_digitally_v": "exactly two phones held by exactly two children, with the same flower photo clearly visible on both phone screens",
    ...
    "ket_spell_v": "a child slowly speaking while a teacher listens and is counting four spoken sounds on four fingers, absolutely no floating letters or numbers",
    ...
    "ket_take_v": "one hand visibly lifting one apple out of a bowl while several apples remain inside the bowl",
    ...
    "ket_tidy_adj_v": "a school-age child actively tidying a bedroom by putting scattered toys into a storage box, with some toys still on the floor and a neat shelf nearby",
...
FEELING_SCENES = {
    ...
    "ket_hard_adj_adv": "a worried school-age child struggling with a very difficult large jigsaw puzzle, many small pieces scattered across the table, only one small section completed after repeated attempts",
...
PERSON_REFERENCE_SCENES = {
    "ket_all_kinds_of_det_pron": "a large collection containing many kinds of toys, vehicles, animals, and balls together",
    "ket_all_sorts_of_det_pron": "many assorted craft materials of different shapes, colors, and textures arranged together",
    "ket_anybody_pron": "a child offering a spare umbrella toward a varied crowd so any person may take it",
    "ket_anyone_pron": "a coach inviting any one child from a diverse circle to step forward",
    "ket_anything_pron": "a child reaching freely into a basket filled with many completely different objects",
    "ket_each_other_pron": "two children helping each other tie the ends of one shared ribbon",
    "ket_everybody_pron": "an entire crowd of children and adults all raising one hand together",
    "ket_everyone_pron": "every child in a complete circle joining the same friendly group activity",
    "ket_everything_pron": "a child packing every visible toy and book from an otherwise empty room into one box",
    "ket_he_pron": "a clear foreground hand pointing specifically toward one boy standing alone",
    "ket_her_det_pron": "one girl holding her own backpack close while standing beside it",
    "ket_hers_pron": "a girl proudly pointing to one bicycle that belongs to her while another child stands apart",
    "ket_herself_pron": "a girl independently braiding her own hair while looking in a mirror",
    "ket_him_pron": "a girl handing a bright red ball directly to one boy",
    "ket_himself_pron": "a boy independently tying his own shoelaces with nobody helping",
    "ket_his_det_pron": "one boy holding his own backpack close while standing beside it",
    "ket_i_pron": "one child pointing clearly to their own chest to identify themself",
    "ket_it_pron": "a clear foreground hand pointing specifically toward one neutral toy robot",
    "ket_itself_pron": "a cat cleaning itself by licking its own front paw",
    "ket_me_pron": "one child among a small group touching their own chest as another child points to them",
    "ket_mine_pron": "a child hugging one favorite teddy bear and pointing proudly to their own chest",
    "ket_myself_pron": "one child alone pointing to their own reflection in a mirror",
    "ket_no_one_pron": "an open doorway and an entirely empty room with no person present",
    "ket_nobody_pron": "a completely empty playground with swings and benches but no people",
    "ket_nothing_pron": "a child looking inside a completely empty open box",
    "ket_other_det_pron": "a child setting one red cup aside and choosing the other blue cup",
    "ket_ours_pron": "a group of children jointly holding and pointing to one shared model house",
    "ket_ourselves_pron": "a group of children building a tent entirely by themselves with no adult help",
    "ket_several_det_pron": "a small group of several apples, clearly more than two but not a large pile",
    "ket_she_pron": "a clear foreground hand pointing specifically toward one girl standing alone",
    "ket_somebody_pron": "one unidentified person seen from behind ringing a house doorbell",
    "ket_someone_pron": "one unidentified person far away waving toward the viewer",
    "ket_something_pron": "a curious child discovering one mysterious object hidden beneath a plain cloth",
    "ket_that_conj_pron": "a foreground hand pointing toward one blue ball far away across a field",
    "ket_theirs_pron": "a group of children jointly pointing to one shared box of toys that belongs to them",
    "ket_them_pron": "an adult offering a basket directly to a clearly separate group of children",
    "ket_themselves_pron": "several children independently preparing their own lunches without adult help",
    "ket_these_det_pron": "a foreground hand pointing to several red apples very close to the viewer",
    "ket_they_pron": "a clearly separate group of three children walking together in the distance",
    "ket_this_det_pron": "a foreground hand pointing to one red ball very close to the viewer",
    "ket_those_det_pron": "a foreground hand pointing toward several colorful kites far away in the sky",
    "ket_us_pron": "a teacher warmly inviting an entire nearby group of children to come with her",
    "ket_we_pron": "a small team of children all pointing to themselves together",
    "ket_what_det_pron": "a puzzled child lifting a cloth to discover an unfamiliar hidden object",
    "ket_which_det_pron": "a child carefully choosing between two different pairs of shoes",
    "ket_who_pron": "a child looking across a row of different people while trying to identify one person",
    "ket_whose_det_pron": "several children examining one unclaimed backpack and wondering who owns it",
    "ket_you_pron": "one smiling child pointing directly outward toward the viewer",
    "ket_yours_pron": "a child offering a bright ball directly toward the viewer as the viewer's ball",
    "ket_yourself_pron": "one child independently caring for themself by fastening their own coat in a mirror",
}

TIME_DATE_SCENES = {
    "ket_a_m_adv": "a child waking in the early morning beside a plain analog clock as the sun rises",
    "ket_afternoon_n": "a child playing outside after lunch while the sun is lower in a bright afternoon sky",
    "ket_age_n": "the stages of one person shown as a baby, child, adult, and elderly person in order",
    "ket_beginning_n": "a runner waiting at a plain starting line just before a race begins, no writing",
    "ket_birth_n": "happy parents gently holding their newborn baby for the first time",
    "ket_birthday_n": "a child celebrating a birthday with a candle cake, balloons, and gifts, no writing or numbers",
    "ket_calendar_n": "one clean paper calendar page made of blank square day cells with no letters or numbers",
    "ket_centimetre_centimeter_cm_n": "a short pencil being measured by a plain ruler with simple tick marks and no numbers",
    "ket_century_n": "a visual progression from an old horse carriage to a modern electric car across a long span of history",
    "ket_daily_adj_adv": "the same child watering the same plant across a row of repeated sunrises",
    "ket_date_n": "a blank calendar grid with one single day square clearly circled, no letters or numbers",
    "ket_day_n": "a bright daytime landscape under a large sun and clear blue sky",
    "ket_degree_n": "a plain outdoor thermometer showing hot weather beside a shining sun, no numbers",
    "ket_evening_n": "a family having dinner as warm lamps glow and the sun sets outside",
    "ket_future_n": "a child imagining themself grown up as an astronaut beside a futuristic spacecraft",
    "ket_gram_me_n": "a tiny amount of flour on a kitchen balance scale with no digits or labels",
    "ket_half_det_n_pron": "one apple cut cleanly into two equal halves with both halves visible",
    "ket_holiday_n": "a cheerful family with suitcases relaxing beside the sea on holiday",
    "ket_hour_n": "a large plain analog clock beside a full one-hour sandglass, no numbers",
    "ket_lunchtime_n": "children eating sandwiches and fruit together at a school lunch table",
    "ket_meeting_n": "several adults seated around one table having a focused meeting, no documents with writing",
    "ket_midday_n": "a person outdoors at midday with the bright sun directly overhead and a very short shadow",
    "ket_midnight_n": "a quiet sleeping town beneath a dark sky with the moon directly overhead",
    "ket_minute_n": "a small one-minute sand timer with sand quickly running through it, no numbers",
    "ket_moment_n": "a child catching one delicate soap bubble at the exact fleeting moment it touches a finger",
    "ket_month_n": "one calendar page containing about thirty blank day squares, no letters or numbers",
    "ket_monthly_adj_adv": "several calendar pages in a row, each with the same recurring day square marked, no writing",
    "ket_morning_n": "a child eating breakfast beside a window filled with warm sunrise light",
    "ket_night_n": "a child sleeping in bed beneath a dark window filled with the moon and stars",
    "ket_noon_n": "a picnic at noon with the sun at the highest point of a clear sky",
    "ket_o_clock_adv": "a plain analog clock with the minute hand exactly at the top hour mark, no numbers",
    "ket_p_m_adv": "a child returning home in late afternoon light beside a plain analog clock",
    "ket_past_prep_n": "a child looking back at an old faded family photograph beside a modern present-day scene",
    "ket_quarter_n": "a round pie divided into four equal slices with exactly one slice separated",
    "ket_season_n": "the same tree shown in four sections for spring blossoms, summer leaves, autumn colors, and winter snow",
    "ket_second_adj_det_n": "two runners finishing a race with one child clearly arriving second behind the winner",
    "ket_time_n": "a clear collection of a wall clock, wristwatch, and sand timer together, no numbers",
    "ket_today_n_adv": "a child actively enjoying the present day beside one currently highlighted blank calendar square",
    "ket_tomorrow_n_adv": "a child packing a backpack at night for an activity planned after the next sunrise",
    "ket_tonight_n_adv": "a child setting up a telescope at dusk for stargazing later that night",
    "ket_week_n": "one row of seven distinct blank day tiles showing a complete week, no letters or numbers",
    "ket_weekday_n": "children carrying backpacks to school across a row of five plain day tiles",
    "ket_weekend_n": "a family enjoying a relaxed picnic across two plain day tiles at the end of a week",
    "ket_weekly_adj_adv": "the same child attending one activity once across each repeated seven-day cycle, no writing",
    "ket_working_hours_n": "an adult working at a desk through daylight while a plain clock shows time passing",
    "ket_year_n": "one complete cycle through spring, summer, autumn, and winter around the same tree",
...
TIME_FREQUENCY_SCENES = {
    "ket_afterwards_adv": "exactly two side-by-side scenes: left scene shows a muddy child finishing football, right scene shows the same child showered and wearing clean clothes afterwards",
    "ket_again_adv": "exactly two side-by-side scenes showing the same child building the same block tower first and building it again, no additional panels",
    "ket_already_adv": "two separate children with separate puzzles: one completed puzzle held proudly on the left, only loose pieces and a just-starting child on the right",
    ...
    "ket_never_adv": "five separate scenes showing the same child always choosing fruit while an untouched sweet remains aside in every scene",
    "ket_now_adv": "a child actively tying a shoelace at the present moment beside a plain clock",
    "ket_often_adv": "exactly six panels: exactly five show the same child cycling and one clearly different panel shows the child reading",
    "ket_once_adv": "a row of several blank activity panels with the child appearing in exactly one panel",
    "ket_sometimes_adv": "exactly six panels: exactly two show the child cycling and the other four show clearly different non-cycling activities",
    ...
    "ket_then_adv": "exactly two panels: left panel shows hands being washed under running water, right panel shows the same child eating afterwards",
    "ket_twice_adv": "exactly two child figures side by side showing the same child jumping twice, no other people or repeated figures",
...
FINAL_RETRY_SCENES = {
    "ket_already_adv": "exactly two side-by-side puzzle tables: on the left a child has already completed every puzzle piece, while on the right another child is only opening a pile of loose pieces",
    "ket_anymore_adv": "exactly two side-by-side scenes of the same child: on the left the younger child rides a tricycle, while on the right the older child walks past the same dusty unused tricycle toward a bicycle",
    "ket_away_adv": "a large house on the far left and a child on the far right walking toward the right edge with their back clearly turned away from the house",
    "ket_before_adv_conj_prep": "exactly two side-by-side scenes: on the left a child washes both hands, and on the right the same child eats a meal after washing",
    "ket_behind_adv_prep": "one child hiding directly behind one thick tree trunk, with only the child's head and one shoulder peeking out from behind the trunk",
    "ket_better_adj_adv": "one blue toy car with all four wheels newly repaired and rolling smoothly while a child proudly holding the repaired car gives a strong thumbs up; one broken wheel lies discarded behind",
    "ket_bit_n_adv": "a full bowl of rice beside one tiny spoon holding only three grains, with the tiny amount on the spoon as the focus",
    "ket_cent_n": "one single tiny completely blank copper coin beside a much larger plain banknote, with absolutely no marks on either",
    "ket_could_mv": "a child paused at a fork where exactly two open safe paths lead in different directions, looking thoughtfully from one possible path to the other",
    "ket_delayed_adj": "tired passengers waiting with luggage beside a stationary broken bus while a mechanic repairs its open engine and the sun sets",
    "ket_design_process_n": "exactly three side-by-side stages of one chair design: a simple line sketch with no writing, a cardboard chair prototype, and the finished wooden chair",
    "ket_discount_n": "exactly two identical toy bears: the left bear beside a large pile of ten blank coins and the right bear beside a smaller pile of five blank coins",
    "ket_euro_n": "a pile of completely blank gold-and-silver coins resting on a simplified map shape of Europe, all coin faces smooth and unmarked",
    "ket_exactly_adv": "a close hand pressing one green puzzle piece exactly into the only matching green-edged hole on a nearly complete puzzle board",
    "ket_folder_n": "one closed blue paper folder with a tab and several separate blank loose sheets visibly protruding from inside, clearly not a book",
    "ket_full_adj": "one transparent glass filled completely to the very rim with orange juice, liquid touching the brim with no empty space",
    "ket_half_price_adj": "two identical red toy boats beside two vertical stacks of smooth blank coins, with the left stack tall and the right coin pile exactly half as tall",
    "ket_have_to_mv": "a child indoors completing a required floor-cleaning chore while an adult waits by the closed door and friends wait to play outside",
    "ket_important_adj": "an adult carefully fastening one large bright life jacket securely onto a child before a boat ride, with the safety equipment as the clear focus",
    "ket_impossible_adj": "a child trying to push one enormous square block toward one tiny round hole that is far too small and the wrong shape",
    "ket_left_hand_adj": "an overhead view of both hands on a table: the left hand on the left side wears a red bracelet and draws a flower, while the right hand lies flat and empty",
    "ket_look_out_phr_v": "exactly two children: one child points upward with a shocked warning face while a ball falling toward the second child's head is clearly visible above",
    "ket_lose_v": "a worried child wearing one red mitten on one hand and staring at the other bare hand while searching an empty backpack, with no second mitten anywhere",
    "ket_mechanic_n": "one adult vehicle mechanic in plain coveralls kneeling beside a safely raised full-size car with one wheel removed and tools on the floor",
    "ket_mistake_n": "a simple shape-sorter board with one round hole and one triangle hole while a child mistakenly holds the triangle piece over the round hole",
    "ket_must_mv": "an adult firmly fastens a safety helmet onto a child before the child may touch the parked bicycle beside them",
    "ket_my_det": "one child points directly to their own chest with one hand while hugging their own backpack tightly with the other arm",
    "ket_never_adv": "one child with arms firmly crossed, head shaking and face turned away from a bowl of broccoli pushed far across the table, showing complete refusal",
    "ket_new_adj": "exactly two bicycles side by side: an old rusty scratched bicycle on the left and a shiny spotless new bicycle on the right",
    "ket_off_adv": "one table lamp with a completely black unlit bulb and its power plug visibly disconnected from the wall socket, no hand and no glow anywhere",
    "ket_olympic_adj": "international athletes carrying a plain flaming sports torch into a large stadium while other athletes wear medals, no podium and no signs",
    "ket_opinion_n": "exactly two children viewing the same abstract painting: the left child smiles and gives thumbs up while the right child frowns and gives thumbs down",
    "ket_outside_prep_adv": "one closed cardboard box centered on the floor and one cat sitting clearly beside and fully outside the box without overlapping it",
    "ket_paragraph_n": "one blank sheet containing one compact rectangular group of six short horizontal blue brush strokes, separated by a large empty gap from a second group, no letters",
    "ket_part_n": "a partly assembled toy car with exactly three wheels attached while a child holds the fourth matching wheel beside the one empty axle",
    "ket_pence_n": "several tiny completely blank copper coins grouped together, every surface smooth with no symbols, letters, or numbers",
    "ket_possibly_adv": "a thoughtful child shrugging at a fork between two possible paths, one sunny and one cloudy, with neither path chosen yet",
    "ket_pound_n": "one large completely blank twelve-sided gold coin beside one completely blank purple banknote, with no marks of any kind",
    "ket_price_n": "one plain toy train beside the exact pile of smooth blank coins needed to buy it, with the product and coin pile equally clear",
    "ket_problem_n": "a worried child holding the detached front wheel in both hands far away from a bicycle frame whose empty front fork has no wheel",
    "ket_real_adj": "a fresh real apple cut open to reveal seeds beside a plastic toy apple with a visible molded seam and a small wind-up key",
    "ket_ruler_n": "one plain wooden ruler measuring a red pencil, showing only evenly spaced tick marks without any digits, letters, or symbols",
    "ket_sale_n": "exactly one shopkeeper handing one toy train to one customer while the customer gives a small pile of smooth blank coins",
    "ket_social_media_n": "exactly three children holding exactly three phones, with the same family photo visible on all three blank screens as they share it together",
    "ket_sometimes_adv": "exactly four equal panels of the same child: exactly one panel shows cycling and the other three show swimming, reading, and painting",
    "ket_spare_adj": "exactly four chairs in one row: exactly three occupied by children and exactly one extra empty chair at the end",
    "ket_spell_v": "a child slowly speaks exactly four sounds shown only as four colored round dots while a teacher listens and holds up four fingers, no characters",
    "ket_spelling_n": "a teacher listens as a child slowly speaks separate sounds shown only as four colored round dots between them, no characters or punctuation",
    "ket_suddenly_adv": "exactly two side-by-side moments: an intact balloon beside a calm child on the left, and the balloon bursting into fragments as the same child jumps in surprise on the right",
    "ket_thin_adj": "one extremely thin notebook shown edge-on beside one very thick book, making the thickness contrast unmistakable",
    "ket_title_n": "one closed blank book cover with a wide empty colored band across only the very top while a child points specifically to that top band",
    "ket_tomorrow_n_adv": "exactly two side-by-side scenes: at night a child packs a backpack, then after the next sunrise the same child carries it out the door",
    "ket_total_adj_n": "two empty bowls held upside down above one center basket, with apples visibly falling from both bowls into the same basket to form one combined group",
    "ket_trouble_n": "a child's kite is tightly tangled high in a tree while the child below looks distressed and cannot reach it",
    "ket_true_adj": "a child honestly points to a broken vase and admits what happened to a listening adult, with no speech bubble",
    "ket_turn_off_phr_v": "a close hand actively pressing a plain wall switch downward while the nearby lamp changes to completely dark with no glow",
    "ket_vocabulary_n": "children matching object picture cards to the corresponding real objects: an apple card beside an apple and a dog card beside a toy dog, no writing",
    "ket_winner_n": "one runner crossing a plain finish ribbon clearly first while exactly two other runners remain far behind, no podium",
    "ket_without_prep": "a soaked child standing in heavy rain with both empty hands visible and no umbrella anywhere in the entire scene",
    "ket_year_n": "exactly four equal panels showing the same tree in spring blossoms, summer green leaves, autumn orange leaves, and winter snow",
    "ket_yes_adv": "one child clearly nodding their head and giving a strong thumbs-up in response to an offered apple",
}
...
def build_prompt(word: dict[str, Any]) -> str:
    ...
    scene = FINAL_RETRY_SCENES.get(word["id"], scene)
    return (
